...
class MinHeap {
     ...
     *         So sánh phần tử mới với phần tử cha của nó. Nếu phần tử cha lớn hơn phần tử mới, hãy hoán đổi chúng
     *         Lặp lại bước 2 cho đến khi phần tử cha nhỏ hơn hoặc bằng phần tử mới hoặc cho đến khi phần tử mới đạt đến gốc của cây
    ...
    public function peek()
    {
        ...
        // echo "Root node min heap: $root\n";
        return $root;
    }

    public function show()
    {
        echo "Min heap : " . implode(" - ", $this->heap) . "\n";
    }
}

// $minHeap = new MinHeap();

// $minHeap->build([15, 5, 15, 2, 20, 30, 1]);
